  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, usersSnapshot) {
        int liveTotalUsers = 0;
        int liveActiveCreators = 0;

        if (usersSnapshot.hasData && usersSnapshot.data!.docs.isNotEmpty) {
          liveTotalUsers = usersSnapshot.data!.docs.length;
          liveActiveCreators = usersSnapshot.data!.docs.where((doc) {
            final r = (doc.data()['role'] as String? ?? '').toLowerCase();
            return r == 'creator' || r == 'seller';
          }).length;
        }
          ...
          builder: (context, ordersSnapshot) {
            ...
            return BlocBuilder<AdminBloc, AdminState>(
              builder: (context, state) {
                final displayUsers = liveTotalUsers > 0 ? liveTotalUsers : state.totalUsersCount;
                final displayCreators = liveActiveCreators > 0 ? liveActiveCreators : state.activeCreatorsCount;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GridView.count(
                          ...
                          children: [
                            AdminStatCard(title: 'Total Users', value: '$displayUsers', icon: Icons.people, color: Colors.blue),
                            AdminStatCard(title: 'Active Creators', value: '$displayCreators', icon: Icons.palette, color: AppColors.primary),
